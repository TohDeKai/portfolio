  ...
  return (
    <section>
      <div className="pt-8 px-4 max-w-screen-xl text-center lg:pt-16 lg:px-12 2xl:ml-72 flex flex-col lg:flex-row items-start lg:items-center">
        <div className="flex-shrink-0 w-full px-4 pt-8 lg:px-12 lg:w-auto pr-0 lg:pr-4">
          ...
          <h2 className="mb-4 text-left text-2xl font-medium tracking-normal leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-white">
            Aspiring Software Engineer
          </h2>
          <p className="lg:mb-8 text-left text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
